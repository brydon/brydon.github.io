...
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#142b2a"><meta name="description" content="${place.short} — Brydon Eastman's research, code, and life beyond the work."><title>${place.short} — Brydon Eastman</title><link rel="icon" href="/favicon.ico"><link rel="stylesheet" href="/styles/switchback.css"><link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600&family=Silkscreen&display=swap" rel="stylesheet"></head>
<body class="reading-page"><a class="skip-link" href="#content">Skip to content</a><header class="site-header"><a class="wordmark" href="/">BRYDON EASTMAN<span class="brand-dot" aria-hidden="true">.</span></a><nav aria-label="Main navigation">${nav}</nav><a class="back-to-world" href="/">Back to Switchback ↗</a></header><div class="reading-landscape" aria-hidden="true"></div><main id="content" class="reading-main"><div class="reading-heading"><span class="eyebrow">SWITCHBACK / ${place.category.toUpperCase()}</span><h1>${place.title}</h1></div><article class="prose">${content}</article></main><footer class="reading-footer"><a href="/">← Back to the valley</a><span>Brydon Eastman · <a href="/contact.html">Say hello</a></span></footer><script type="module" src="/js/reading.mjs"></script></body></html>`;
